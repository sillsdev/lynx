...
describe('ScriptureDeltaDocument', () => {
  ...
  it('update single line in a paragraph', () => {
    ...
    document.update(new Delta().retain(16).insert(' again', { segment: 'verse_1_1' }).ops, 2);
  ...
  it('add verse at end of a paragraph', () => {
    ...
    document.update(
      new Delta()
        ...
        .insert('This is a new verse.', { segment: 'verse_1_1a' }).ops,
      2,
    );
  ...
  it('update multiple paragraphs', () => {
    ...
    document.update(
      new Delta()
        ...
        .insert('\n', { para: { style: 'p' } })
        .insert({ verse: { number: '2', style: 'v' } })
        .insert('This is not ', { segment: 'verse_1_2' }).ops,
      2,
    );
  ...
  it('update no paragraph', () => {
    ...
    document.update(new Delta().retain(16).delete(1).insert('one').ops, 2);
