...
export type { EditFactory } from './edit-factory';
...
export type { ScriptureNode } from './scripture-document';
export { ScriptureDocument, ScriptureNodeType } from './scripture-document';
...
export { TextEditFactory } from './text-edit-factory';
export { TextScriptureDocument } from './text-scripture-document';
export { TextScriptureEditFactory } from './text-scripture-edit-factory';
